...
#pragma pack(pop)
  ...
  // NPU1 telemetry handler, override for rtos_telemetry only
  class npu1_telemetry_handler : public telemetry_handler {
  public:
    xrt_core::query::rtos_telemetry::result_type
    query_rtos_telemetry(const shim_xdna::pdev& pci_dev) const override {
      return query::rtos_telemetry::result_type{};
    }
  };
  ...
  public:
    ...
    query_stream_buffer_telemetry(const shim_xdna::pdev& pci_dev) const override {
      ...
      return xrt_core::query::stream_buffer_telemetry::result_type{};
    }
  };
