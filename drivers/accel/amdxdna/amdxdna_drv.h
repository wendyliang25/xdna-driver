 ...
 *
 * Transport-independent (common) amdxdna DRM/device declarations, shared by the
 * PCI driver and the platform driver.  The PCI-only (device, revision) match
 * table and the PCI device_info externs live in amdxdna_pci_drv.h.
 */
