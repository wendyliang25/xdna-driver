 ...
 * binding.  Shared by the PCI driver (amdxdna_pci_drv.c) and the device-tree
 * platform driver (amdxdna_platform.c); both hand the ioctls off to the
 * per-device amdxdna_dev_ops.
 */
